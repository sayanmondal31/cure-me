...
class Information {
  ...
  Future<dynamic> covidHospitalsAnd() async {
    var url2 = 'https://api.rootnet.in/covid19-in/hospitals/beds';
    NetworkHelper networkHelper = NetworkHelper(url2);
    var hospitalAndBed = await networkHelper.getData();
    return hospitalAndBed;
  }
